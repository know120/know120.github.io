          ...
          <div className="glass-panel rounded-2xl p-6 md:p-8">
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-1 rounded-full text-xs font-medium transition-all flex items-center gap-1 ${inputMode === 'voice'
            ...
            <div className="flex gap-4">
              ...
              <button
                ...
                className={`flex-1 py-3 rounded-lg font-bold text-white transition-all ${isSubmitting
